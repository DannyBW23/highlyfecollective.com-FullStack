...
UPLOAD_FOLDER = '/Users/danielweir/highlyfe3/app/static/images'
	...
	if not app.debug and not app.testing:
		if app.config['MAIL_SERVER']:
			...
			if app.config['MAIL_USE_TLS']:
				secure = ()
			mail_handler = SMTPHandler(mailhost=(app.config['MAIL_SERVER'], app.config['MAIL_PORT']),fromaddr='no-reply@' + app.config['MAIL_SERVER'],toaddrs=app.config['ADMINS'], subject='Highlyfe Failure',credentials=auth, secure=secure)
